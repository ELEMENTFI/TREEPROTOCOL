...
/**
 * @title eBNB Compound Staking Smart Contract - Pancakeswap version
 * @dev A smart-contract to distribute eBNB over time and accumulates CAKE on behalf of stakers.
 *
 *      Distribution tokens are added to a locked pool in the contract and become unlocked over time
 *      according to a once-configurable unlock schedule. Once unlocked, they are available to be
 *      claimed by users.
 *
 *      On unstaking, users reveive eBNB and CAKE based on the number of shares and seconds staked.
 *      To incentivize staking over longer period of time users earn a multiplier on eBNB rewards
...
contract PrabhStaking is Ownable {
    ...
    IBEP20 public stakingToken = IBEP20(0xf730d0aa2fDF7b03FB08218EBC6B03522D87C32a); // PRABH-BUSD LP
   
    // Pancakeswap constants

    IMasterChef private pcsMasterChef = IMasterChef(0xde30edbD7644d61931ef48d09888cb24881cE7aC);
     ...
     */
    function initialize(uint256 maxUnlockSchedules, uint256 startBonus_, uint256 bonusPeriodSec_, uint256 initialSharesPerToken) public {
